...
/**
 * <p>Java class for DQ_DataQuality_PropertyType complex type.
 * 
...
@XmlType(name = "DQ_DataQuality_PropertyType", propOrder = {
    "dqDataQuality"
})
public class DQDataQualityPropertyType {

    @XmlElement(name = "DQ_DataQuality")
    protected DQDataQualityType dqDataQuality;
     ...
     *     
     */
    public void setDQDataQuality(DQDataQualityType value) {
        this.dqDataQuality = value;
    }

    public boolean isSetDQDataQuality() {
        return (this.dqDataQuality!= null);
    }

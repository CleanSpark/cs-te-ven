...
/**
 * <p>Java class for MD_LegalConstraints_PropertyType complex type.
 * 
...
@XmlType(name = "MD_LegalConstraints_PropertyType", propOrder = {
    "mdLegalConstraints"
})
public class MDLegalConstraintsPropertyType {

    @XmlElement(name = "MD_LegalConstraints")
    protected MDLegalConstraintsType mdLegalConstraints;
     ...
     *     
     */
    public void setMDLegalConstraints(MDLegalConstraintsType value) {
        this.mdLegalConstraints = value;
    }

    public boolean isSetMDLegalConstraints() {
        return (this.mdLegalConstraints!= null);
    }

 ...
 * 
 * <p>Java class for CylindricalCSPropertyType complex type.
 * 
...
@XmlType(name = "CylindricalCSPropertyType", propOrder = {
    "cylindricalCS"
})
public class CylindricalCSPropertyType {

    @XmlElementRef(name = "CylindricalCS", namespace = "http://www.opengis.net/gml/3.2", type = CylindricalCSUpperCase.class, required = false)
    protected CylindricalCSUpperCase cylindricalCS;
     ...
     *     
     */
    public CylindricalCSUpperCase getCylindricalCS() {
     ...
     *     
     */
    public void setCylindricalCS(CylindricalCSUpperCase value) {

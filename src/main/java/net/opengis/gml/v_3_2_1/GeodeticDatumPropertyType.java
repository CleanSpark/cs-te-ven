 ...
 * 
 * <p>Java class for GeodeticDatumPropertyType complex type.
 * 
...
@XmlType(name = "GeodeticDatumPropertyType", propOrder = {
    "geodeticDatum"
})
public class GeodeticDatumPropertyType {

    @XmlElementRef(name = "GeodeticDatum", namespace = "http://www.opengis.net/gml/3.2", type = GeodeticDatumUpperCase.class, required = false)
    protected GeodeticDatumUpperCase geodeticDatum;
     ...
     *     
     */
    public GeodeticDatumUpperCase getGeodeticDatum() {
     ...
     *     
     */
    public void setGeodeticDatum(GeodeticDatumUpperCase value) {

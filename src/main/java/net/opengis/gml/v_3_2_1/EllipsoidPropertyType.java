 ...
 * 
 * <p>Java class for EllipsoidPropertyType complex type.
 * 
...
@XmlType(name = "EllipsoidPropertyType", propOrder = {
    "ellipsoid"
})
public class EllipsoidPropertyType {

    @XmlElementRef(name = "Ellipsoid", namespace = "http://www.opengis.net/gml/3.2", type = EllipsoidUpperCase.class, required = false)
    protected EllipsoidUpperCase ellipsoid;
     ...
     *     
     */
    public EllipsoidUpperCase getEllipsoid() {
        return ellipsoid;
    }
     ...
     *     
     */
    public void setEllipsoid(EllipsoidUpperCase value) {

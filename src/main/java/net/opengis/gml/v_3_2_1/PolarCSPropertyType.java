 ...
 * 
 * <p>Java class for PolarCSPropertyType complex type.
 * 
...
@XmlType(name = "PolarCSPropertyType", propOrder = {
    "polarCS"
})
public class PolarCSPropertyType {

    @XmlElementRef(name = "PolarCS", namespace = "http://www.opengis.net/gml/3.2", type = PolarCSUpperCase.class, required = false)
    protected PolarCSUpperCase polarCS;
     ...
     *     
     */
    public PolarCSUpperCase getPolarCS() {
        return polarCS;
    }
     ...
     *     
     */
    public void setPolarCS(PolarCSUpperCase value) {
        this.polarCS = value;
    }

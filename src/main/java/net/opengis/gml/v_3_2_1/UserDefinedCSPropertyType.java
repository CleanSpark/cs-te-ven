 ...
 * 
 * <p>Java class for UserDefinedCSPropertyType complex type.
 * 
...
@XmlType(name = "UserDefinedCSPropertyType", propOrder = {
    "userDefinedCS"
})
public class UserDefinedCSPropertyType {

    @XmlElementRef(name = "UserDefinedCS", namespace = "http://www.opengis.net/gml/3.2", type = UserDefinedCSUpperCase.class, required = false)
    protected UserDefinedCSUpperCase userDefinedCS;
     ...
     *     
     */
    public UserDefinedCSUpperCase getUserDefinedCS() {
     ...
     *     
     */
    public void setUserDefinedCS(UserDefinedCSUpperCase value) {

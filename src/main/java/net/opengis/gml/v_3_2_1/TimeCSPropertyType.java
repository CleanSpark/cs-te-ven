 ...
 * 
 * <p>Java class for TimeCSPropertyType complex type.
 * 
...
@XmlType(name = "TimeCSPropertyType", propOrder = {
    "timeCS"
})
public class TimeCSPropertyType {

    @XmlElementRef(name = "TimeCS", namespace = "http://www.opengis.net/gml/3.2", type = TimeCSUpperCase.class, required = false)
    protected TimeCSUpperCase timeCS;
     ...
     *     
     */
    public TimeCSUpperCase getTimeCS() {
        return timeCS;
    }
     ...
     *     
     */
    public void setTimeCS(TimeCSUpperCase value) {
        this.timeCS = value;
    }

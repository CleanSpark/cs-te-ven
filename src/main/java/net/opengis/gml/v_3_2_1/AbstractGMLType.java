...
public abstract class AbstractGMLType {
    ...
    protected List<CodeType> nameGML;
    ...
    /**
     * Gets the value of the nameGML property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the nameGML property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getNameGML().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<CodeType> getNameGML() {
        if (nameGML == null) {
            nameGML = new ArrayList<CodeType>();
        }
        return this.nameGML;
    }

    public boolean isSetNameGML() {
        return ((this.nameGML!= null)&&(!this.nameGML.isEmpty()));
    }

    public void unsetNameGML() {
        this.nameGML = null;
    }

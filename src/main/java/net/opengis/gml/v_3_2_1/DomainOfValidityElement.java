...
@XmlRootElement(name = "domainOfValidity")
public class DomainOfValidityElement {

    @XmlAnyElement
    protected Element exExtent;
     ...
     *     
     */
    public void setEXExtent(Element value) {
        this.exExtent = value;
    }

 ...
 * 
 * <p>Java class for OperationParameterPropertyType complex type.
 * 
...
@XmlType(name = "OperationParameterPropertyType", propOrder = {
    "operationParameter"
})
public class OperationParameterPropertyType {

    @XmlElementRef(name = "OperationParameter", namespace = "http://www.opengis.net/gml/3.2", type = OperationParameterUpperCase.class, required = false)
    protected OperationParameterUpperCase operationParameter;
     ...
     *     
     */
    public OperationParameterUpperCase getOperationParameter() {
     ...
     *     
     */
    public void setOperationParameter(OperationParameterUpperCase value) {

 ...
 * 
 * <p>Java class for EllipsoidalCSPropertyType complex type.
 * 
...
@XmlType(name = "EllipsoidalCSPropertyType", propOrder = {
    "ellipsoidalCS"
})
public class EllipsoidalCSPropertyType {

    @XmlElementRef(name = "EllipsoidalCS", namespace = "http://www.opengis.net/gml/3.2", type = EllipsoidalCSUpperCase.class, required = false)
    protected EllipsoidalCSUpperCase ellipsoidalCS;
     ...
     *     
     */
    public EllipsoidalCSUpperCase getEllipsoidalCS() {
     ...
     *     
     */
    public void setEllipsoidalCS(EllipsoidalCSUpperCase value) {

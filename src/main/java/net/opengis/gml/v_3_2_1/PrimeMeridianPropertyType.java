 ...
 * 
 * <p>Java class for PrimeMeridianPropertyType complex type.
 * 
...
@XmlType(name = "PrimeMeridianPropertyType", propOrder = {
    "primeMeridian"
})
public class PrimeMeridianPropertyType {

    @XmlElementRef(name = "PrimeMeridian", namespace = "http://www.opengis.net/gml/3.2", type = PrimeMeridianUpperCase.class, required = false)
    protected PrimeMeridianUpperCase primeMeridian;
     ...
     *     
     */
    public PrimeMeridianUpperCase getPrimeMeridian() {
     ...
     *     
     */
    public void setPrimeMeridian(PrimeMeridianUpperCase value) {

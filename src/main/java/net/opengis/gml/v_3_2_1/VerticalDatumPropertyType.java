...
public class VerticalDatumPropertyType {
    ...
    @XmlElementRef(name = "VerticalDatum", namespace = "http://www.opengis.net/gml/3.2", type = VerticalDatumUpperCase.class, required = false)
    protected VerticalDatumUpperCase verticalDatum;
     ...
     *     
     */
    public VerticalDatumUpperCase getVerticalDatum() {
     ...
     *     
     */
    public void setVerticalDatum(VerticalDatumUpperCase value) {

 ...
 * 
 * <p>Java class for CartesianCSPropertyType complex type.
 * 
...
@XmlType(name = "CartesianCSPropertyType", propOrder = {
    "cartesianCS"
})
public class CartesianCSPropertyType {

    @XmlElementRef(name = "CartesianCS", namespace = "http://www.opengis.net/gml/3.2", type = CartesianCSUpperCase.class, required = false)
    protected CartesianCSUpperCase cartesianCS;
     ...
     *     
     */
    public CartesianCSUpperCase getCartesianCS() {
        return cartesianCS;
    }
     ...
     *     
     */
    public void setCartesianCS(CartesianCSUpperCase value) {

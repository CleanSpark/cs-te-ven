...
public class TemporalDatumPropertyType {
    ...
    @XmlElementRef(name = "TemporalDatum", namespace = "http://www.opengis.net/gml/3.2", type = TemporalDatumUpperCase.class, required = false)
    protected TemporalDatumUpperCase temporalDatum;
     ...
     *     
     */
    public TemporalDatumUpperCase getTemporalDatum() {
     ...
     *     
     */
    public void setTemporalDatum(TemporalDatumUpperCase value) {
